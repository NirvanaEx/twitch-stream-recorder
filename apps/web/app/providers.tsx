...
const dictionaries: Record<Locale, Dictionary> = {
  ru: {
    ...
    channels: {
      ...
      inputHintVkPlay: "Например: https://live.vkvideo.ru/iserveri или iserveri",
  ...
  en: {
    ...
    channels: {
      ...
      inputHintVkPlay: "Example: https://live.vkvideo.ru/iserveri or iserveri",
