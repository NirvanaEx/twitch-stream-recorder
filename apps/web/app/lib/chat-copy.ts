...
export const CHAT_COPY = {
  ru: {
    ...
    firstMessage: "1-е сообщение",
    firstMessageTitle: "Первое сообщение этого пользователя в канале",
    ...
    userCardHistory: "История прошлых эфиров",
    userCardHistoryLoading: "Загружаю прошлые сообщения…",
    userCardHistoryRetry: "История не загрузилась — повторить",
    userCardHistoryLimit: "показаны последние 1000",
    userCardPastStream: "Сообщение из прошлого эфира",
    userCardMore: "Показать ещё 100 (старше)",
    ...
    eventPoll: "Опрос",
    eventOpen: "Приём ставок",
    eventLocked: "Ставки закрыты",
    eventResolved: "Итог",
    eventCancelled: "Отменено — очки вернули",
    eventWinner: "Победил",
    eventPollDone: "Опрос завершён",
    eventPoints: "очков",
    eventVotes: "голосов",
    eventUsers: "участников",
    eventBetOn: "Поставил на",
    eventReturn: "Коэффициент",
  ...
  en: {
    ...
    firstMessageTitle: "The author's first ever message in this channel",
    ...
    userCardHistory: "Previous broadcasts",
    userCardHistoryLoading: "Loading earlier messages…",
    userCardHistoryRetry: "History could not load — retry",
    userCardHistoryLimit: "latest 1000 shown",
    userCardPastStream: "Message from an earlier broadcast",
    userCardMore: "Show 100 more (older)",
    ...
    eventPoll: "Poll",
    eventOpen: "Betting open",
    eventLocked: "Bets closed",
    eventResolved: "Result",
    eventCancelled: "Cancelled — points refunded",
    eventWinner: "Winner",
    eventPollDone: "Poll finished",
    eventPoints: "points",
    eventVotes: "votes",
    eventUsers: "backers",
    eventBetOn: "Bet on",
    eventReturn: "Return",
    eventAlreadyOpen: "Was already running when the recording began",
  },
} as const;
